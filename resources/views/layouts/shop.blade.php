                                        ...
                                        @foreach ($brands as $brand)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands" value="{{$brand->id}}" type="checkbox">
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    <span class="font-light grid-content">{{$product->catagory->name}}</span>
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        <span class="font-light">{{$product->catagory->name}}</span>
